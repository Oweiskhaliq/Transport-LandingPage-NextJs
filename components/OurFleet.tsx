...
const OurFleet = () => {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4   md:px-8">
        {fleet.map((item, index) => (
          ...
          >
            ...
            <p className="text-[19px] mt-4 px-5 lg:text-[24px]  text-center   text-[#161921] md:px-[16px] hover:text-[#c09550]">
              {item.text}
            </p>
          </div>
        ))}
